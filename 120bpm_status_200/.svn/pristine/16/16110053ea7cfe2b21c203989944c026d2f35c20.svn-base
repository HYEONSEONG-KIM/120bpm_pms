...
<div class="right btnArea backgroundColor ">
    <button class="btn gobackBtn controlBtn" data-gopage="${cPath }/project/${pCode}/freeboard/list">취소</button>
            ...
            success: function(res) {
                if (res == 'OK') {
                    ...
                    Swal.fire({
                        ...
                        location.href = "redirect:freeboard/freeUpdate";
                    })
                }
            }
