...
public class NoticePagingVO<T> { //최초만들어질때 pagingVO-> Controller ->memberdao시그니처 처리위해 2개의 메소드(totalRecord, 구간별조회레코드 메소드) ->마바 
	...
	public NoticePagingVO(int screenSize, int blockSize) { //필요하다면 두개의 생성자를 이용해 값을 바꿀 수 있다.
	...
	public void setNoticeInfo(NoticeVO noticeInfo) {
